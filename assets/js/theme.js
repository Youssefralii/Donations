(function($) {
    ...
    // TESTIMONIAL onath_testomonial_page
    $('.onath_testomonial_active').slick({
        infinite: true,
        autoplay: true,
        autoplaySpeed: 3000,
        speed: 700,
    ...
    $('.one_page .onath_menu .nav_scroll').onePageNav({
